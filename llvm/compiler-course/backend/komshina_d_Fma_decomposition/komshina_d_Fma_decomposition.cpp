...
namespace {
    ...
    static bool getDecomposedOpcodes(unsigned Opcode, unsigned& MulOpc, unsigned& AddOpc) {
        switch (Opcode) {
        case X86::VFMADD132SSr: case X86::VFMADD213SSr: case X86::VFMADD231SSr:
            MulOpc = X86::VMULSSrr;
            AddOpc = X86::VADDSSrr;
            return true;
        case X86::VFMADD132PSr: case X86::VFMADD213PSr: case X86::VFMADD231PSr:
            MulOpc = X86::VMULPSrr;
            AddOpc = X86::VADDPSrr;
            return true;
        case X86::VFMADD132SDr: case X86::VFMADD213SDr: case X86::VFMADD231SDr:
            MulOpc = X86::VMULSDrr;
            AddOpc = X86::VADDSDrr;
            return true;
        case X86::VFMADD132PDr: case X86::VFMADD213PDr: case X86::VFMADD231PDr:
            MulOpc = X86::VMULPDrr;
            AddOpc = X86::VADDPDrr;
            return true;
        default:
