...
private:
    ...
    MachineInstr* findMultiplyInstruction(MachineRegisterInfo& MRI, const MachineInstr& Sub) const {
        ...
        return (MulOpcode == X86::VMULSSrr || MulOpcode == X86::VMULSDrr) ? Mul : nullptr;
    }

    void fuseMultiplySubtract(MachineBasicBlock& MBB, MachineBasicBlock::iterator& MI, MachineInstr& Sub, MachineInstr* Mul, const X86InstrInfo* TII) {
        ...
        unsigned NewOpcode = (Sub.getOpcode() == X86::VSUBSSrr) ? X86::VFNMADD213SSr : X86::VFNMADD213SDr;
...
X("mul_sub", "Fuse MUL + SUB into VFMSUB213 instructions", false,
    false);