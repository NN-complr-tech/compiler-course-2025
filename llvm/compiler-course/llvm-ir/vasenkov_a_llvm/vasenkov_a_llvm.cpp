    ...
    for (auto &block : func) {
      ...
      for (auto &instruction : block) {
        ...
        if (divisorValue == 1 || divisorValue == -1) {
          Value *optimizedValue = (divisorValue == 1) ? 
            dividend : builder.CreateNeg(dividend);
