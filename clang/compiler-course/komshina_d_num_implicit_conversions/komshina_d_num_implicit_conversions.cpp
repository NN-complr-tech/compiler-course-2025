...
namespace {
    ...
    class ImplicitConversionsAnalyzer final : public clang::RecursiveASTVisitor<ImplicitConversionsAnalyzer> {
    public:
        ...
        bool VisitCXXConstructExpr(clang::CXXConstructExpr* Conv) {
            if (Conv->getNumArgs() == 0) return true;
...
X("Implicit_Conversions_Komshina_Daria_FIIT1_ClangAST", "Count implicit type conversions");