...
public:
	...
	void Conversions(const clang::QualType &FromType, const clang::QualType &ToType) {
...
public:
	...
	bool ParseArgs(const clang::CompilerInstance& C, const std::vector<std::string>& Args) override {
		return true;
	}
};
...
X("Implicit_Conv_Chizhov_Maxim_FIIT3_ClangAST", "Counts implicit type conversions");
