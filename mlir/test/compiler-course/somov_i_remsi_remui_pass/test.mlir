// RUN: mlir-opt -load-pass-plugin=%mlir_lib_dir/Remsi_remui_pass_Somov_Ivan_FIIT1_MLIR%shlibext \
// RUN: --pass-pipeline="builtin.module(deconstruct-remainder-pass-by-ilya-lopatin)" %s | FileCheck %s
