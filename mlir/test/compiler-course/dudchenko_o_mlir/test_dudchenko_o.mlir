// RUN: mlir-opt -load-pass-plugin=%mlir_lib_dir/ReplaceMathCeil_Dudchenko_Olesya_FIIT2_MLIR%shlibext \
// RUN: --pass-pipeline="builtin.module(ReplaceMathCeil_Dudchenko_Olesya_FIIT2_MLIR)" %s | FileCheck %s
