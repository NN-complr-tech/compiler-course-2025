// RUN: mlir-opt -load-pass-plugin=%mlir_lib_dir/FunctionCallAnalyzerPass_Korobeinikov_Arseny_FIIT1_MLIR%shlibext \
// RUN: --pass-pipeline="builtin.module(FunctionCallAnalyzerPass_Korobeinikov_Arseny_FIIT1_MLIR)" %s | FileCheck %s
