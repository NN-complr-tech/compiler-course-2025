...
struct CallCounterPass : public PassWrapper<CallCounterPass, OperationPass<ModuleOp>> {
  ...
  StringRef getArgument() const final { return "CallCounterPass_IvashchukVA_FIIT2_MLIR"; }
  StringRef getDescription() const final { return "Count function calls in MLIR"; }
